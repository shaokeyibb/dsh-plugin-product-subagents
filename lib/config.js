...
export const pluginConfigSchema = z.object({
  ...
  // '' opts out of namespacing and registers the bare provider keys — only
  // safe on a profile with no official product subagent plugins.
  providerNamespace: z.string().regex(/^[A-Za-z0-9_.-]*$/, 'must be empty or [A-Za-z0-9_.-]').optional(),
